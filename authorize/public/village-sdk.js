// Deployed: 2025-09-08T05:34:49.916Z
// Version: 1.0.47
(function() {
  "use strict";
  try {
...
(function(exports) {
  ...
  function buildIframeSrc({
    ...
    return `${"https://village.do"}/widget?${params.toString()}`;
  }
  ...
  class MessageHandlers {
    ...
    handleOAuthRequest(data) {
      ...
      const baseUrl = `${"https://village.do"}/widget/${isAuthorizationFlow ? "resolve-auth" : "oauth"}`;
      const params = new URLSearchParams();
    ...
    handleOAuthSuccess(data) {
      ...
      const villageOrigin = "https://village.do";
      if (this.app.oauthPopupRef && !this.app.oauthPopupRef.closed) {
...
`;
  ...
  const _App = class _App {
    ...
    constructor(partnerKey, config) {
      ...
      this.apiUrl = "https://api.village.do";
    ...
    updateCookieToken(token) {
      ...
      if (this.isTokenValid(token)) {
        ...
        api.set("village.token", token, cookieOptions);
        if (this.token != token) {
          this.token = token;
    ...
    async getAuthToken(timeout = 1e3, domain) {
    ...
    handleOAuthRequest() {
      const baseUrl = `${"https://village.do"}/widget/oauth`;
      const params = new URLSearchParams();
  ...
  (function(window2) {
    ...
    function createVillage() {
      ...
      const v = {
        ...
        getPathsCTA() {
          var _a;
          let pathsCTA = Array.isArray((_a = v == null ? void 0 : v._config) == null ? void 0 : _a.paths_cta) && v._config.paths_cta.length > 0 ? v._config.paths_cta : [];
        ...
        authorize: async function(tokenOrUserRef, domainOrDetails, refreshCallback) {
          ...
          if (isTokenAuth) {
            ...
            try {
              ...
              const fetchedToken = await v._app.getAuthToken(2e3, domainOrDetails);
    ...
    if (!window2.__village_message_listener_attached__) {
      window2.addEventListener("message", async (event) => {
        ...
        const domainB = new URL("https://village.do").hostname;
...
//# sourceMappingURL=village-sdk.js.map
