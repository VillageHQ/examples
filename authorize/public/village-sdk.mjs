...
var Et = (t, e, n) => e in t ? wt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var xe = (t, e, n) => Et(t, typeof e != "symbol" ? e + "" : e, n);
const L = {
...
function Te({
  ...
  return i.append("paths_cta", c), `http://localhost:3000//widget?${i.toString()}`;
}
function St(t, e) {
...
class At {
  ...
  handleOAuthSuccess(e) {
    O.set("village.token", e.token, { secure: !0, expires: 60 }), this.app.handleOAuthSuccess(e), this.app.oauthPopupRef && !this.app.oauthPopupRef.closed ? (this.app.oauthPopupRef.postMessage(
...
`;
function We(t, e = {}) {
  console.log("%cVILLAGE-PAAS ERROR", Tt), console.log("%c────────────────────────", Le);
  const n = [
    {
      label: "ERROR MESSAGE",
      value: t.message
...
const Ot = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Ue = { randomUUID: Ot };
function xt(t, e, n) {
  var s;
  if (Ue.randomUUID && !t)
...
const { toString: Lt } = Object.prototype, { getPrototypeOf: _e } = Object, se = /* @__PURE__ */ ((t) => (e) => {
  const n = Lt.call(e);
  return t[n] || (t[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), x = (t) => (t = t.toLowerCase(), (e) => se(e) === t), ie = (t) => (e) => typeof e === t, { isArray: z } = Array, W = ie("undefined");
function Ut(t) {
...
const It = ie("string"), C = ie("function"), Xe = ie("number"), oe = (t) => t !== null && typeof t == "object", vt = (t) => t === !0 || t === !1, Y = (t) => {
  if (se(t) !== "object")
    return !1;
  const e = _e(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, Nt = x("Date"), Dt = x("File"), qt = x("Blob"), Vt = x("FileList"), Bt = (t) => oe(t) && C(t.pipe), Ft = (t) => {
  let e;
...
}, Mt = x("URLSearchParams"), [Ht, zt, jt, $t] = ["ReadableStream", "Request", "Response", "Headers"].map(x), Kt = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
function ge() {
  const { caseless: t } = Ye(this) && this || {}, e = {}, n = (r, s) => {
    const o = t && Qe(e, s) || s;
    Y(e[o]) && Y(r) ? e[o] = ge(e[o], r) : Y(r) ? e[o] = ge({}, r) : z(r) ? e[o] = r.slice() : e[o] = r;
  };
...
const Wt = (t, e, n, { allOwnKeys: r } = {}) => (J(e, (s, o) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    r.push(n);
  return r;
}, nn = x("HTMLFormElement"), rn = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), Pe = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), sn = x("RegExp"), Ze = (t, e) => {
...
const dn = (t) => {
  ...
  return n(t, 0);
}, hn = x("AsyncFunction"), fn = (t) => t && (oe(t) || C(t)) && C(t.then) && C(t.catch), et = ((t, e) => t ? setImmediate : e ? ((n, r) => (q.addEventListener("message", ({ source: s, data: o }) => {
...
function ae(t, e, n) {
  ...
  function d(f, g, p) {
    ...
    if (f && !p && typeof f == "object") {
      ...
      else if (l.isArray(f) && gn(f) || (l.isFileList(f) || l.endsWith(g, "[]")) && (E = l.toArray(f)))
        return g = rt(g), E.forEach(function(R, P) {
          !(l.isUndefined(R) || R === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? Ie([g], P, o) : i === null ? g : g + "[]",
            u(R)
          );
        }), !1;
    }
    return ye(f) ? !0 : (e.append(Ie(p, g, o), u(f)), !1);
  }
  ...
  function S(f, g) {
    if (!l.isUndefined(f)) {
      ...
      h.push(f), l.forEach(f, function(E, b) {
...
}, En = typeof URLSearchParams < "u" ? URLSearchParams : ke, Sn = typeof FormData < "u" ? FormData : null, bn = typeof Blob < "u" ? Blob : null, Rn = {
  isBrowser: !0,
  classes: {
    URLSearchParams: En,
    FormData: Sn,
...
}, Ce = typeof window < "u" && typeof document < "u", we = typeof navigator == "object" && navigator || void 0, An = Ce && (!we || ["ReactNative", "NativeScript", "NS"].indexOf(we.product) < 0), Tn = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
function at(t) {
  function e(n, r, s, o) {
    ...
    return i = !i && l.isArray(s) ? s.length : i, c ? (l.hasOwnProp(s, i) ? s[i] = [s[i], r] : s[i] = r, !a) : ((!s[i] || !l.isObject(s[i])) && (s[i] = []), e(n, r, s[i], o) && l.isArray(s[i]) && (s[i] = xn(s[i])), !a);
  }
...
const G = {
  ...
  transformRequest: [function(e, n) {
    ...
    return o || s ? (n.setContentType("application/json", !1), Ln(e)) : e;
  }],
...
const Un = l.toObjectSet([
  ...
  return t && t.split(`
`).forEach(function(i) {
    s = i.indexOf(":"), n = i.substring(0, s).trim().toLowerCase(), r = i.substring(s + 1).trim(), !(!n || e[n] && Un[n]) && (n === "set-cookie" ? e[n] ? e[n].push(r) : e[n] = [r] : e[n] = e[n] ? e[n] + ", " + r : r);
  }), e;
}, De = Symbol("internals");
function $(t) {
...
const dt = (t) => {
  ...
  return e;
}, jn = typeof XMLHttpRequest < "u", $n = jn && function(t) {
  return new Promise(function(n, r) {
    const s = dt(t);
    let o = s.data;
    const i = k.from(s.headers).normalize();
    let { responseType: a, onUploadProgress: c, onDownloadProgress: u } = s, d, h, y, S, f;
    function g() {
    ...
    }, o === void 0 && i.setContentType(null), "setRequestHeader" in p && l.forEach(i.toJSON(), function(P, _) {
      p.setRequestHeader(_, P);
    }), l.isUndefined(s.withCredentials) || (p.withCredentials = !!s.withCredentials), a && a !== "json" && (p.responseType = s.responseType), u && ([y, f] = ne(u, !0), p.addEventListener("progress", y)), c && p.upload && ([h, S] = ne(c), p.upload.addEventListener("progress", h), p.upload.addEventListener("loadend", S)), (s.cancelToken || s.signal) && (d = (R) => {
      p && (r(!R || R.type ? new j(null, t, p) : R), p.abort(), p = null);
  ...
  if (e || n) {
    ...
    const o = function(u) {
      if (!s) {
        ...
        r.abort(d instanceof m ? d : new j(d instanceof Error ? d.message : d));
      }
    };
    let i = e && setTimeout(() => {
  ...
  return t && !e;
}), Me = 64 * 1024, Ee = ht && ft(() => l.isReadableStream(new Response("").body)), re = {
  stream: Ee && ((t) => t.body)
};
le && ((t) => {
...
const Yn = async (t) => {
  ...
  let S = Kn([s, o && o.toAbortSignal()], i), f;
  const g = S && S.unsubscribe && (() => {
    S.unsubscribe();
  });
  let p;
  try {
    if (c && Qn && n !== "get" && n !== "head" && (p = await Zn(d, r)) !== 0) {
      let _ = new Request(e, {
        method: "POST",
        body: r,
        duplex: "half"
      }), v;
      if (l.isFormData(r) && (v = _.headers.get("content-type")) && d.setContentType(v), _.body) {
        const [N, X] = qe(
          p,
          ne(Ve(c))
        );
    ...
    if (Ee && (a || R && g)) {
      ...
      const v = l.toFiniteNumber(b.headers.get("content-length")), [N, X] = a && qe(
        v,
        ne(Ve(a), !0)
      ) || [];
      b = new Response(
    ...
    u = u || "text";
    let P = await re[l.findKey(re, u) || "text"](b, t);
    return !R && g && g(), await new Promise((_, v) => {
      ct(_, v, {
        data: P,
    ...
    throw g && g(), E && E.name === "TypeError" && /fetch/i.test(E.message) ? Object.assign(
      new m("Network Error", m.ERR_NETWORK, t, f),
      {
        cause: E.cause || E
      }
    ) : m.from(E, E && E.code, t, f);
  }
}), Se = {
  http: mn,
  xhr: $n,
...
` + o) : r.stack = o;
  ...
  _request(e, n) {
    ...
    if (!c) {
      ...
      for (f.unshift.apply(f, a), f.push.apply(f, u), y = f.length, d = Promise.resolve(n); h < y; )
        d = d.then(f[h++], f[h++]);
      return d;
    }
    y = a.length;
...
w.mergeConfig = B;
w.AxiosHeaders = k;
w.formToJSON = (t) => at(l.isHTMLForm(t) ? new FormData(t) : t);
...
}, K = "village.distinct_id";
class D {
  static getDistinctId() {
    let e = localStorage.getItem(K);
    if (e) return e;
    const n = xt();
    return localStorage.setItem(K, n), n;
  }
  static setUserId(e) {
    const n = localStorage.getItem(K);
    n && n !== e && pe.merge(n, e), localStorage.setItem(K, e);
  }
  static removeUserId() {
...
const I = class I {
  static getInstance(e, n) {
    return I.instance || (I.instance = new I(e, n)), I.instance;
  }
  constructor(e, n) {
    this.partnerKey = e, this.userReference = null, this.token = O.get("village.token"), this.config = n, this.url = null, this.module = null, this.iframe = null, this.observer = null, this.inlineSearchIframes = /* @__PURE__ */ new Map(), this.messageHandlers = new At(this), this.moduleHandlers = new or(this), this.apiUrl = "http://localhost:8000", this.hasRenderedButton = !1, this.elementRequests = /* @__PURE__ */ new Map(), this.elementRequestIds = /* @__PURE__ */ new Map(), this.globalRequestCounter = 0, this.initialized = !1;
  }
  async init() {
  ...
  async addListenerToElement(e) {
    ...
    const n = e.getAttribute(F), r = e.getAttribute(M);
    if (r === H.SEARCH) {
      const s = {
      ...
      o && this.inlineSearchIframes.set(e, o);
    } else
      this.inlineSearchIframes.delete(e), n && r != H.SYNC && r != H.SEARCH ? this.moduleHandlers.handleDataUrl(e, n) : this.moduleHandlers.handleModule(
        e,
        r || H.SYNC
  ...
  updateCookieToken(e) {
    if (this._clearAllRequests(), this.isTokenValid(e)) {
      ...
      O.set("village.token", e, n), this.token != e && (this.token = e, this._refreshInlineSearchIframes());
    }
  }
  updateCookieTokenWithDomain(e, n) {
    if (this._clearAllRequests(), this.isTokenValid(e)) {
      this.saveExtensionTokenWithDomain(e, n);
      const r = {
        secure: location.protocol === "https:",
        expires: 60,
        path: "/"
      };
      O.set("village.token", e, r), this.token != e && (this.token = e, this.authDomain = n, this._refreshInlineSearchIframes());
    }
  }
  isTokenValid(e) {
    return typeof e == "string" && e.length > 10 && e !== "not_found";
  }
  async getAuthToken(e = 1e3, n) {
    let r = O.get("village.token"), s = null;
    if (this.isTokenValid(r) || (r = this.extractTokenFromQueryParams()), !this.isTokenValid(r))
      try {
        const o = await this.requestExtensionToken(e, n);
        typeof o == "object" && o.token ? (r = o.token, s = o.domain, n && s && n !== s && (console.warn(`[Village SDK] Domain mismatch: requested ${n}, got ${s}`), r = null)) : typeof o == "string" && (r = o);
      } catch {
      }
    return this.isTokenValid(r) && (n || s ? this.updateCookieTokenWithDomain(r, n || s) : this.updateCookieToken(r)), r;
  }
  requestExtensionToken(e, n) {
    const r = {
      type: "STORAGE_GET_TOKEN",
      source: "VillageSDK"
    };
    return n && (r.domain = n), new Promise((s, o) => {
      const i = (c) => {
        if (c.source !== window) return;
        const { source: u, message: d } = c.data || {};
        (u === "VillageExtension" || u === "VillageSDK") && (d != null && d.token) && (window.removeEventListener("message", i), clearTimeout(a), d.token ? s({
          token: d.token,
        ...
        window.removeEventListener("message", i), o(new Error(`Extension did not respond in time ${e}`));
      }, e);
      window.addEventListener("message", i), window.postMessage(r, "*");
    });
  }
  ...
  saveExtensionTokenWithDomain(e, n) {
    const r = {
      type: "STORAGE_SET_TOKEN",
      source: "VillageSDK",
      token: e,
  ...
  async validateToken(e) {
    if (!this.isTokenValid(e))
      return !1;
    try {
      const { data: n } = await w.get(`${this.apiUrl}/user`, {
  ...
  async getUser() {
    ...
    if (e)
      try {
        ...
        this._clearAllRequests(), this.token = null, O.remove("village.token"), D.removeUserId();
      }
  }
  handleOAuthRequest() {
  ...
  async checkPaths(e) {
    ...
    try {
      ...
      return ((r = (n = s == null ? void 0 : s.response) == null ? void 0 : n.data) == null ? void 0 : r.auth) === !1 && (this._clearAllRequests(), O.remove("village.token"), this.token = null), null;
    }
  }
  getButtonChildren(e) {
  ...
  initializeButtonState(e) {
    this.token ? this._setElementState(e, "loading") : this._setElementState(e, "not-found");
  }
  ...
  _setElementState(e, n, r = null) {
    ...
    [s, o, i, a, c].filter(Boolean).forEach((d) => {
    ...
    switch (n) {
      case "loading":
        ...
        break;
      case "found":
        u = s, u && r && this.addFacePilesAndCount(s, r);
        break;
      case "not-found":
      case "error":
        u = o;
    ...
    u && (u.style.cssText = "display: inline-flex !important");
  }
  _clearAllRequests() {
    this.elementRequests.clear(), this.elementRequestIds.clear(), this.globalRequestCounter += 1e3;
  }
  ...
  destroy() {
    this._clearAllRequests(), this.observer && (this.observer.disconnect(), this.observer = null), this.inlineSearchIframes.forEach((n, r) => {
    ...
    }), this.iframe && this.iframe.element && this.iframe.element.parentNode && this.iframe.element.parentNode.removeChild(this.iframe.element), this.iframe && this.iframe.spinner && this.iframe.spinner.parentNode && this.iframe.spinner.parentNode.removeChild(this.iframe.spinner), this.iframe = null, I.instance === this && (I.instance = null), this.initialized = !1;
  }
  ...
  async logout() {
    ...
    try {
      this.token && await w.get(`${this.apiUrl}/logout`, {
        headers: {
          "x-access-token": this.token,
          "app-public-key": this.partnerKey
        }
    ...
    O.remove("village.token"), this.token = null, D.removeUserId(), this.refreshSyncUrlElements(), this._refreshInlineSearchIframes();
  }
};
xe(I, "instance", null);
let Ae = I;
...
(function(t) {
  ...
  function e() {
    const o = {}, i = {
      ...
      updatePathsCTA(a = []) {
        var c;
        return i._config.paths_cta = Array.isArray(a) ? a : [], (c = i.broadcast) == null || c.call(i, L.pathsCtaUpdated, i._config.paths_cta), i;
      },
      /** Add a single CTA object on the fly */
      addPathCTA(a) {
        var c;
        return a && typeof a.label == "string" && a.callback ? (i._config.paths_cta.push(a), (c = i.broadcast) == null || c.call(i, L.pathsCtaUpdated, i._config.paths_cta)) : console.warn("[Village] Invalid CTA object:", a), i;
      },
      sendStorageGetToken() {
        t.postMessage({
          source: "VillageSDK",
      ...
      off(a, c) {
        o[a] && (o[a] = o[a].filter((u) => u !== c));
      },
      on: $e,
      emit: Ke,
      dispatch(a, c) {
        try {
          t.dispatchEvent(new CustomEvent(a, { detail: c }));
        } catch (u) {
          console.warn(`[Village] Failed to dispatch CustomEvent in current window for "${a}":`, u);
        }
      },
      broadcast(a, c) {
        var u, d;
        (u = i.emit) == null || u.call(i, a, c), (d = i.dispatch) == null || d.call(i, a, c);
      },
      _processQueue: function() {
        for (; i.q.length > 0; ) {
          var a = i.q.shift(), c = a[0], u = a.slice(1);
          typeof i[c] == "function" && i[c].apply(i, ...u);
        }
      },
      init(a, c) {
        ...
        }, i._initialized = !0, i._renderWidget(), Array.isArray(c == null ? void 0 : c.paths_cta) && c.paths_cta.length && i.updatePathsCTA(c.paths_cta), i;
      },
      identify: function(a, c) {
        return i._initialized ? new Promise((u, d) => {
          i._userReference = a, i._app.setUserReference(a, c).then(() => u()).catch((h) => d(h));
        }) : (i.q.push(["identify", a, c]), Promise.resolve());
      },
      logout: function() {
        if (!i._initialized) {
          i.q.push(["logout"]);
      ...
      _renderWidget: function() {
        return new Promise((a, c) => {
          var u;
          try {
            i._app || (i._app = Ae.getInstance(i._partnerKey, i._config)), i._app.init(), (u = i.broadcast) == null || u.call(i, L.widgetReady, {
      ...
      getPathsCTA() {
        var c;
        let a = Array.isArray((c = i == null ? void 0 : i._config) == null ? void 0 : c.paths_cta) && i._config.paths_cta.length > 0 ? i._config.paths_cta : [];
        if (!Array.isArray(a) || a.length === 0) {
          const u = new URLSearchParams(t.location.search).get("paths_cta");
          try {
            const d = JSON.parse(decodeURIComponent(u));
      ...
      executeCallback(a) {
        const c = i.getPathsCTA();
        for (let u = 0; u < c.length; u++) {
          const d = c[u];
          if (d.callback && a.index == u)
            return d.callback(a), !0;
        }
        t !== t.parent && t.parent.postMessage(a, "*");
      },
      authorize: async function(a, c, u) {
        if (!i._initialized)
          return new Promise((h) => {
            i.q.push(["__deferred_authorize__", a, c, u, h]);
          });
        if (typeof a == "string" && a.length > 20 && (a.includes(".") || a.includes("_")))
          return c ? i._authorizeWithToken(a, c, u) : {
            ok: !1,
            status: "unauthorized",
            reason: "Domain is required for token-based authorization"
          };
        if (a)
          return i.identify(a, c);
        if (c)
          try {
            i._app || await i._renderWidget();
            const h = await i._app.getAuthToken(2e3, c);
            return h && i._app.isTokenValid(h) ? i._authorizeWithToken(h, c, u) : {
              ok: !1,
              status: "unauthorized",
              reason: "No token found for domain: " + c
            };
          } catch (h) {
            return console.warn("[Village] Failed to fetch token from extension:", h), {
              ok: !1,
              status: "unauthorized",
              reason: "Failed to fetch token: " + h.message
            };
          }
        else
          return {
      ...
      _authorizeWithToken: async function(a, c, u) {
        try {
          if (i._authToken = a, i._authDomain = c, i._refreshCallback = u, i._app || await i._renderWidget(), i._app.token = a, c && (i._app.authDomain = c), await i._app.validateToken(a))
            return i._app.updateCookieTokenWithDomain(a, c), {
              ok: !0,
              status: "authorized",
              domain: c
            };
          if (u && typeof u == "function")
            try {
              ...
              if (h && typeof h == "string")
                return i._authorizeWithToken(h, c, null);
            } catch (h) {
      ...
      __deferred_authorize__: async function(a, c, u, d) {
        const h = await i.authorize(a, c, u);
        return d == null || d(h), h;
      }
    };
    return i;
  ...
  t.Village = e(), t.Village.on = $e, t.Village.emit = Ke, t.Village.q = r.concat(t.Village.q);
  function s() {
    t.Village._processQueue();
  }
  document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", s) : setTimeout(s, 0), t.Village.on(L.widgetReady, () => {
  }), t.Village.on(L.pathCtaClicked, (o) => {
    t.Village.executeCallback(o);
  }), t.Village.on(L.oauthSuccess, (o) => {
    console.log("✅ Village OAuth success", o);
  }), t.__village_message_listener_attached__ || (t.addEventListener("message", async (o) => {
    const { origin: i, data: a } = o, c = new URL(i).hostname, u = new URL("http://localhost:3000/").hostname;
    if (c === u && (a == null ? void 0 : a.type) === "VillageSDK") {
      console.log("[SDK cookie] message from iframe:", a);
      const d = a.token ?? null;
      if (!d && document.requestStorageAccess) {
        try {
          await document.requestStorageAccess();
          const h = O.get("village.token"), y = sessionStorage.getItem("village.token");
          console.warn("[VillageSDK] Storage Access ", h, y), h && (sessionStorage.setItem("village.token", h), t.Village.broadcast(L.oauthSuccess, { token: h }));
        } catch (h) {
          console.warn("[VillageSDK] Storage Access denied or failed", h);
        }
        return;
      }
      d ? (O.set("village.token", d, {
        secure: !0,
        sameSite: "None",
        expires: 60
      }), sessionStorage.setItem("village.token", d), t.Village.broadcast(L.oauthSuccess, { token: d })) : (O.remove("village.token"), sessionStorage.removeItem("village.token"), t.Village.broadcast(L.userLoggedOut, {}));
      return;
    }
    !a || a.source !== "VillageSDK" || a.type === L.pathCtaClicked && t.Village.executeCallback(a.payload || a);
