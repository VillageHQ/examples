...
```javascript
// Check Village instance
console.log('Village instance:', window.Village);

// Listen to all events
Village.on('*', (event, data) => {
  console.log('Village event:', event, data);
});
```
...
For issues or questions about the Village Widget SDK:
- Documentation: [Village Developer Docs](https://docs.village.com)
- Support: support@village.com

For issues with this React extension example:
...
This example is provided as-is for educational purposes. The Village Widget SDK is proprietary software - please refer to Village's terms of service for usage rights.