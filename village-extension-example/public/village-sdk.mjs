...
function Te({
  ...
  return i.append("paths_cta", u), `http://localhost:3000/widget?${i.toString()}`;
}
function St(t, e) {
...
class At {
  ...
  handleOAuthSuccess(e) {
    U.set("village.token", e.token, { secure: !0, expires: 60 }), this.app.handleOAuthSuccess(e), this.app.oauthPopupRef && !this.app.oauthPopupRef.closed ? (this.app.oauthPopupRef.postMessage(
...
), ve = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), sn = O("RegExp"), Ze = (t, e) => {
  ...
  function d(f, g, p) {
    ...
    if (f && !p && typeof f == "object") {
      if (l.endsWith(g, "{}"))
        ...
        return g = rt(g), w.forEach(function(R, v) {
          !(l.isUndefined(R) || R === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? Pe([g], v, o) : i === null ? g : g + "[]",
            c(R)
          );
        }), !1;
    }
...
const dt = (t) => {
  ...
  return new Promise(function(n, r) {
    ...
    "onloadend" in p ? p.onloadend = w : p.onreadystatechange = function() {
      ...
      s.timeoutErrorMessage && (v = s.timeoutErrorMessage), r(new m(
        v,
        _.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED,
        t,
        p
      )), p = null;
    }, o === void 0 && i.setContentType(null), "setRequestHeader" in p && l.forEach(i.toJSON(), function(v, _) {
      p.setRequestHeader(_, v);
...
const Yn = async (t) => {
  ...
  try {
    ...
    c = c || "text";
    let v = await re[l.findKey(re, c) || "text"](b, t);
...
const P = class P {
  ...
  constructor(e, n) {
    this.partnerKey = e, this.userReference = null, this.token = U.get("village.token"), this.config = n, this.url = null, this.module = null, this.iframe = null, this.observer = null, this.inlineSearchIframes = /* @__PURE__ */ new Map(), this.messageHandlers = new At(this), this.moduleHandlers = new or(this), this.apiUrl = "http://localhost:8000", this.hasRenderedButton = !1, this.elementRequests = /* @__PURE__ */ new Map(), this.elementRequestIds = /* @__PURE__ */ new Map(), this.globalRequestCounter = 0, this.processedSignatures = /* @__PURE__ */ new Set(), this.initialized = !1;
  }
  async init() {
  ...
  updateCookieToken(e) {
    if (this._clearAllRequests(), this.isTokenValid(e)) {
      ...
      U.set("village.token", e, n), this.token != e && (this.token = e, this._refreshInlineSearchIframes());
    }
  }
  isTokenValid(e) {
  ...
  async getUser() {
    ...
    if (e)
      try {
        ...
        this._clearAllRequests(), this.token = null, U.remove("village.token"), D.removeUserId();
      }
  }
  handleOAuthRequest() {
  ...
  async checkPaths(e) {
    ...
    try {
      ...
      return ((r = (n = s == null ? void 0 : s.response) == null ? void 0 : n.data) == null ? void 0 : r.auth) === !1 && (this._clearAllRequests(), U.remove("village.token"), this.token = null), null;
    }
  }
  getButtonChildren(e) {
  ...
  async logout() {
    ...
    U.remove("village.token"), this.token = null, D.removeUserId(), this.refreshSyncUrlElements(), this._refreshInlineSearchIframes();
  }
};
xe(P, "instance", null);
let Ae = P;
...
(function(t) {
  ...
  function e() {
    const o = {}, i = {
      ...
      getPathsCTA() {
        var u;
        let a = Array.isArray((u = i == null ? void 0 : i._config) == null ? void 0 : u.paths_cta) && i._config.paths_cta.length > 0 ? i._config.paths_cta : [];
  ...
  document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", s) : setTimeout(s, 0), t.Village.on(x.widgetReady, () => {
    ...
    const { origin: i, data: a } = o, u = new URL(i).hostname, c = new URL("http://localhost:3000/").hostname;
    if (u === c && (a == null ? void 0 : a.type) === "VillageSDK") {
      ...
      if (!d && document.requestStorageAccess) {
        try {
          ...
          const h = U.get("village.token"), y = sessionStorage.getItem("village.token");
      ...
      d ? (U.set("village.token", d, {
        secure: !0,
        sameSite: "None",
        expires: 60
      }), sessionStorage.setItem("village.token", d), t.Village.broadcast(x.oauthSuccess, { token: d })) : (U.remove("village.token"), sessionStorage.removeItem("village.token"), t.Village.broadcast(x.userLoggedOut, {}));
      return;
    }
